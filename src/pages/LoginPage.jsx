    ...
    return (
        <div className="h-screen w-full flex  ">
            <div className=" h-full w-2/3 flex  justify-center items-center ">
                <img src="https://iiitt.ac.in/images/iiitt-logo.png" alt="" className="w-[10vw] h-[10vw]   " />
                <h1 className="w-[20vw]">Indian Institute of Information Technology Tiruchirappalli </h1>
            </div>
